...
namespace Exercice4_Console
{
    class ClientStub
    {
        ...
        static void Main(string[] args)
        {
            ...
            servicehotellapeyronie.WebService1 serviceHotelLapeyronie = new servicehotellapeyronie.WebService1();
            servicehotelibis.WebService2 serviceHotelIbis = new servicehotelibis.WebService2();
            servicehotelkyriad.WebService3 serviceHotelKyriad = new servicehotelkyriad.WebService3();
            ...
            while (true)
            {
                ...
                if(choix.Equals("1"))
                {
                    ...
                    while (true)
                    {
                        ...
                        if (serviceHotelLapeyronie.Authentification(login, password))
                        {
                            string choixOption;
                            ...
                            while (true)
                            {
                                ...
                                else if (choixOption.Equals("1"))
                                {
                                    ...
                                    string offres = serviceHotelLapeyronie.GetListeOffre(dateDebut, dateFin, nombrePersonne);
                                ...
                                else if (choixOption.Equals("2"))
                                {
                                    ...
                                    while (true)
                                    {
                                        ...
                                        string offerORmsgError = serviceHotelLapeyronie.VerifyOffer(idOffre);
                                        ...
                                        else
                                        {
                                            ...
                                            if (choixValidation.Equals("1"))
                                            {
                                                ...
                                                Console.WriteLine("   " + serviceHotelLapeyronie.BookingRegistration(idOffre, client));
                ...
                else if (choix.Equals("2"))
                {
                    ...
                    while (true)
                    {
                        ...
                        if (serviceHotelIbis.Authentification(login, password))
                        {
                            string choixOption;
                            ...
                            while (true)
                            {
                                ...
                                else if (choixOption.Equals("1"))
                                {
                                    ...
                                    string offres = serviceHotelIbis.GetListeOffre(dateDebut, dateFin, nombrePersonne);
                                ...
                                else if (choixOption.Equals("2"))
                                {
                                    ...
                                    while (true)
                                    {
                                        ...
                                        string offerORmsgError = serviceHotelIbis.VerifyOffer(idOffre);
                                        ...
                                        else
                                        {
                                            ...
                                            if (choixValidation.Equals("1"))
                                            {
                                                ...
                                                Console.WriteLine("   " + serviceHotelIbis.BookingRegistration(idOffre, client));
                ...
                else if (choix.Equals("3"))
                {
                    ...
                    while (true)
                    {
                        ...
                        if (serviceHotelKyriad.Authentification(login, password))
                        {
                            string choixOption;
                            ...
                            while (true)
                            {
                                ...
                                else if (choixOption.Equals("1"))
                                {
                                    ...
                                    string offres = serviceHotelKyriad.GetListeOffre(dateDebut, dateFin, nombrePersonne);
                                ...
                                else if (choixOption.Equals("2"))
                                {
                                    ...
                                    while (true)
                                    {
                                        ...
                                        string offerORmsgError = serviceHotelKyriad.VerifyOffer(idOffre);
                                        ...
                                        else
                                        {
                                            ...
                                            if (choixValidation.Equals("1"))
                                            {
                                                ...
                                                Console.WriteLine("   " + serviceHotelKyriad.BookingRegistration(idOffre, client));
