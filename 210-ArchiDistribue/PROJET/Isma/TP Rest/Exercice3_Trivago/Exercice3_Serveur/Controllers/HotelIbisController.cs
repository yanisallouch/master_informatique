...
namespace Exercice3_Serveur.Controllers
{
    ...
    {
        private static Hotel hotelIbis;
        ...
        public void CreateHotelAndGenerateOffers()
        {
            ...
            hotelIbis = new Hotel("Hotel Ibis",
                                         "France",
                                         "Montpellier",
                                         "570 Route de Ganges",
                                         "Ibis",
            ...
            for (int i = 0; i < hotelIbis.ListeChambre.Count; i++)
            {
                Offer offer = new Offer();

                if (i < 10)
                    offer = new Offer("Offre$" + (i + 1), hotelIbis.ListeChambre.ElementAt(i), "2020-03-0" + (i + 1), hotelIbis.ListeChambre.ElementAt(i).PrixChambre - 20, hotelIbis.ListeChambre.ElementAt(i).ImageURL, true);
                else
                    offer = new Offer("Offre$" + (i + 1), hotelIbis.ListeChambre.ElementAt(i), "2020-03-" + (i + 1), hotelIbis.ListeChambre.ElementAt(i).PrixChambre - 20, hotelIbis.ListeChambre.ElementAt(i).ImageURL, true);
