...
namespace Exercice3_Serveur.Controllers
{
    public class HotelIbisController : ApiController
    {
        ...
        [Route("HotelIbis/BookingRegistration")]
        ...
        [Route("HotelIbis/CreateHotelAndGenerateOffers")]
