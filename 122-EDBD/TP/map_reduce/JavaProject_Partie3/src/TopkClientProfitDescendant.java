...
class MapClient extends Mapper<LongWritable, Text, Text, Text> {
	...
	public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
		...
		if(!words[20].equals("Profit")) {
			context.write(new Text(words[5]), value);
		}
	}
}
...
class ReduceClient extends Reducer<Text, Text, Text, DoubleWritable> {
	/**
...
public class TopkClientProfitDescendant {
	private static final String INPUT_PATH = "input-groupBy/";
	private static final String OUTPUT_PATH = "output/TopkClientProfitDesc-";
	private static final Logger LOG = Logger.getLogger(TopkClientProfitDescendant.class.getName());
	...
	public static void main(String[] args) throws Exception {
		...
		job.setReducerClass(ReduceClient.class);
