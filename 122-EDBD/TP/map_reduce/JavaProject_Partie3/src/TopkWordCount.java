...
class MapDemo extends Mapper<LongWritable, Text, Text, IntWritable> {
...
class ReduceDemo extends Reducer<Text, IntWritable, Text, IntWritable> {
	/**
...
public class TopkWordCount {
	private static final String INPUT_PATH = "input-TopK/";
