...
class Map extends Mapper<LongWritable, Text, Text, IntWritable> {
	...
	public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
		...
		if(columns[0].equals("course") || Integer.parseInt(columns[4]) > 4) {
			return;
		}
...
public class Top10Tram {
	private static final String INPUT_PATH = "input-tam";
	private static final String OUTPUT_PATH = "output/Top10Tram-";
	private static final Logger LOG = Logger.getLogger(Top10Tram.class.getName());
	...
	public static void main(String[] args) throws Exception {
		...
		Job job = new Job(conf, "Top station stram");
